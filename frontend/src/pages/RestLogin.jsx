	...
	return (
		<CustomerPage>
			<div
				...
				className="bg-gray-100 h-full text-gray-900 flex justify-center">
				<div className="max-w-screen-xl m-0 sm:m-10 bg-white shadow sm:rounded-lg flex justify-center flex-1">
					<div className="h-full lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
						<div className="h-full mt-12 flex flex-col items-center">
							<h1 className="text-lg font-extrabold">Sign Up/Sign In</h1>

							<div className="h-full w-full flex flex-col flex-1 mt-8">
								<center>
